...
[`usethis::create_from_github()`](https://usethis.r-lib.org/reference/create_from_github.md):
...
[`pr_view()`](https://usethis.r-lib.org/reference/pull-requests.md). And
anyone can follow along with this PR
...
Run [`pr_push()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
[`pr_push()`](https://usethis.r-lib.org/reference/pull-requests.md) to
push their changes into our PR.
...
can run
[`pr_finish()`](https://usethis.r-lib.org/reference/pull-requests.md) to
switch back to the default branch (usually named `main` or `master`),
...
`master`). But
[`pr_pull()`](https://usethis.r-lib.org/reference/pull-requests.md) can
be useful in PRs if there are a few rounds of alternating contributions
from you and the maintainer.
