...
functions
[`usethis::gh_token_help()`](https://usethis.r-lib.org/reference/github-token.md)
and
...
and [`use_github()`](https://usethis.r-lib.org/reference/use_github.md),
as of v2.0.0[^3].
...
[`usethis::edit_r_environ()`](https://usethis.r-lib.org/reference/edit.md)
