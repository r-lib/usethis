...
Call
[`usethis::use_devtools()`](https://usethis.r-lib.org/reference/rprofile-helper.md)
...
- `usethis.description`: named list of default DESCRIPTION fields for
  ...
  [`usethis::create_package()`](https://usethis.r-lib.org/reference/create_package.md).
...
editing via
[`usethis::edit_r_profile()`](https://usethis.r-lib.org/reference/edit.md).
...
[`usethis::use_git_config()`](https://usethis.r-lib.org/reference/use_git_config.md)
...
[`usethis::git_sitrep()`](https://usethis.r-lib.org/reference/git_sitrep.md)
