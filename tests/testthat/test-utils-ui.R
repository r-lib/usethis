test_that("ui_cli_bullets() look as expected", {
...
test_that("ui_cli_bullets() respect usethis.quiet = TRUE", {
...
test_that("ui_cli_bullets() does glue interpolation and inline markup", {
  # suppress test silencing
  withr::local_options(list(usethis.quiet = FALSE))
