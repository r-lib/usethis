...
[`ui_nope()`](https://usethis.r-lib.org/reference/ui-questions.md) have
their own [help
page](https://usethis.r-lib.org/reference/ui-questions.md).

All UI output (apart from
[`ui_yeah()`](https://usethis.r-lib.org/reference/ui-questions.md)/[`ui_nope()`](https://usethis.r-lib.org/reference/ui-questions.md)
prompts) can be silenced by setting `options(usethis.quiet = TRUE)`. Use
[`ui_silence()`](https://usethis.r-lib.org/reference/ui_silence.md) to
silence selected actions.
