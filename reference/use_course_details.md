...
[`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md). Only
`create_download_url()` is exported.
...
- destdir:
  ...
  [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) has
