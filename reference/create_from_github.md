...
pull request with
[`pr_init()`](https://usethis.r-lib.org/reference/pull-requests.md), one
of several [functions for working with pull
requests](https://usethis.r-lib.org/reference/pull-requests.md).
...
- open:
  ...
  If `TRUE`,
  [activates](https://usethis.r-lib.org/reference/proj_activate.md) the
  new project:
...
- [`use_github()`](https://usethis.r-lib.org/reference/use_github.md) to
  go the opposite direction, i.e. create a GitHub repo from your local
  repo

- [`git_protocol()`](https://usethis.r-lib.org/reference/git_protocol.md)
  for background on `protocol` (HTTPS vs SSH)

- [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) to
  download a snapshot of all files in a GitHub repo, without the need
