...
#' }
use_rmarkdown_template <- function(template_dir = "newtemplate",
  ...
  template_create_dir <- if(isTRUE(template_create_dir)) "true" else "false"
  ...
  use_template("rmarkdown-template.Rmd", base_path = base_path,
