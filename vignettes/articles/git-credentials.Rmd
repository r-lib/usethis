...
Git uses so-called credential helpers for this and, happily, they tend to "just work" these days (especially, on macOS and Windows).
...
At the time of writing, `credentials::set_github_pat()` is hard-wired to "github.com", but this may be generalized change in the future.
