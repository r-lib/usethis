...
#| out.width: "90%"
knitr::include_graphics("img/pr-functions-usethis-pr-flow-medium-light.jpeg", dpi = 300)
...
#|     pre-filled.
#| out.width: "90%"
knitr::include_graphics("img/pr-usethis-pr-flow-medium-light.png", dpi = 300)
```