...
This explains how to propose a change to usethis via a pull request using
Git and GitHub. 
...
the [usethis GitHub repo](https://github.com/r-lib/usethis), and 
...
results for [usethis on Travis](https://travis-ci.org/r-lib/usethis) (checks on Linux and/or 
