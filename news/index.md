...
- [`use_tidy_agents()`](https://usethis.r-lib.org/reference/use_tidy_agents.md)
...
- [`learn_tidy_skill()`](https://usethis.r-lib.org/reference/learn_tidy_skill.md)
...
- [`create_from_github()`](https://usethis.r-lib.org/reference/create_from_github.md)
...
- [`pr_init()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
- [`pr_merge_main()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
- [`pr_pull()`](https://usethis.r-lib.org/reference/pull-requests.md),
  [`pr_push()`](https://usethis.r-lib.org/reference/pull-requests.md),
...
- [`pr_resume()`](https://usethis.r-lib.org/reference/pull-requests.md)
  (without a specific `branch`) and
  [`pr_fetch()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
- [`use_git()`](https://usethis.r-lib.org/reference/use_git.md) now
...
- [`use_readme_qmd()`](https://usethis.r-lib.org/reference/use_readme_rmd.md)
  creates a starter `README.qmd` with Quarto-flavored YAML frontmatter,
  analogous to
  [`use_readme_rmd()`](https://usethis.r-lib.org/reference/use_readme_rmd.md)
  ([\#1671](https://github.com/r-lib/usethis/issues/1671)). Thanks
  [@VisruthSK](https://github.com/VisruthSK) for getting the ball
  rolling.
- [`use_description()`](https://usethis.r-lib.org/reference/use_description.md)
  and
  [`use_roxygen_md()`](https://usethis.r-lib.org/reference/use_roxygen_md.md)
...
- [`use_import_from()`](https://usethis.r-lib.org/reference/use_import_from.md)
...
- [`use_env_var()`](https://usethis.r-lib.org/reference/use_env_var.md)
...
- [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md),
  [`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md), and
  [`use_github_action()`](https://usethis.r-lib.org/reference/use_github_action.md)
  no longer emit download or pagination progress when the
  `usethis.quiet` option is `TRUE`.
- [`use_pipe()`](https://usethis.r-lib.org/reference/use_pipe.md) is
  deprecated ([@math-mcshane](https://github.com/math-mcshane),
  [\#2124](https://github.com/r-lib/usethis/issues/2124)).
- [`use_release_issue()`](https://usethis.r-lib.org/reference/use_release_issue.md)
...
- [`use_tidy_upkeep_issue()`](https://usethis.r-lib.org/reference/tidyverse.md)
  no longer includes the deprecated
  [`use_tidy_style()`](https://usethis.r-lib.org/reference/tidy-deprecated.md)
...
- [`create_quarto_project()`](https://usethis.r-lib.org/reference/create_package.md)
...
- [`use_air()`](https://usethis.r-lib.org/reference/use_air.md) is a new
  function to configure a project to use
...
- usethis’s criteria for recognizing a project (listed in
  [`?proj_utils`](https://usethis.r-lib.org/reference/proj_utils.md))
...
- [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) and
  [`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md) open
  the new folder in a new session of the current IDE (RStudio or
...
- [`use_r_universe_badge()`](https://usethis.r-lib.org/reference/badges.md)
...
- Several deprecated functions have been removed:
  ...
  - `use_rscloud_badge()`, deprecated in v2.2.0; use
    [`use_posit_cloud_badge()`](https://usethis.r-lib.org/reference/badges.md)
    instead
  - `git_branch_default()`, deprecated in v2.1.0; use
    [`git_default_branch()`](https://usethis.r-lib.org/reference/git-default-branch.md)
    instead
...
- [`use_vignette()`](https://usethis.r-lib.org/reference/use_vignette.md)
  and
  [`use_article()`](https://usethis.r-lib.org/reference/use_vignette.md)
...
- [`use_data()`](https://usethis.r-lib.org/reference/use_data.md)
...
- [`use_package()`](https://usethis.r-lib.org/reference/use_package.md)
...
- `browse_github_token()` (do
  [`create_github_token()`](https://usethis.r-lib.org/reference/github-token.md))
- `browse_github_pat()` (do
  [`create_github_token()`](https://usethis.r-lib.org/reference/github-token.md))
- `github_token()` (do
  [`gh_token_help()`](https://usethis.r-lib.org/reference/github-token.md)
  or [`gh::gh_token()`](https://gh.r-lib.org/reference/gh_token.html))
- `pr_pull_upstream()` (do
  [`pr_merge_main()`](https://usethis.r-lib.org/reference/pull-requests.md))
- `pr_sync()` (do
  [`pr_merge_main(); pr_push()`](https://usethis.r-lib.org/reference/pull-requests.md))
- `use_appveyor()`
- `use_appveyor_badge()`
- `use_travis()`
- `use_travis_badge()`
...
- `use_tidy_ci()` *deprecated in v2.1.0* (do
  [`use_tidy_github_actions()`](https://usethis.r-lib.org/reference/tidyverse.md))
- `use_tidy_labels()` *deprecated in v2.1.0* (do
  [`use_tidy_github_labels()`](https://usethis.r-lib.org/reference/use_github_labels.md))
...
- [`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md) and
  [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) are
  equipped to handle a ZIP where the parent folder is implicit
  ([@burnsal](https://github.com/burnsal),
  [\#1961](https://github.com/r-lib/usethis/issues/1961)).

- [`use_test_helper()`](https://usethis.r-lib.org/reference/use_test_helper.md)
  is a new function to create a test helper file
  ([@olivroy](https://github.com/olivroy),
  [\#1822](https://github.com/r-lib/usethis/issues/1822)).

- [`use_cpp11()`](https://usethis.r-lib.org/reference/use_cpp11.md)
...
- [`edit_rstudio_snippets()`](https://usethis.r-lib.org/reference/edit.md)
  now accepts yaml snippets ([@olivroy](https://github.com/olivroy),
  [\#1941](https://github.com/r-lib/usethis/issues/1941)).

- [`use_standalone()`](https://usethis.r-lib.org/reference/use_standalone.md)
...
- [`use_release_issue()`](https://usethis.r-lib.org/reference/use_release_issue.md)
  and
  [`use_upkeep_issue()`](https://usethis.r-lib.org/reference/use_upkeep_issue.md)
...
- [`use_github()`](https://usethis.r-lib.org/reference/use_github.md)
...
- [`use_git()`](https://usethis.r-lib.org/reference/use_git.md) no
  longer asks if you want to restart RStudio when using Positron.

- [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) and
  [`use_r()`](https://usethis.r-lib.org/reference/use_r.md) now work
...
- [`usethis::use_version()`](https://usethis.r-lib.org/reference/use_version.md)
...
- Internal helper `cran_version()`, used in functions such as
  ...
  [`use_news_md()`](https://usethis.r-lib.org/reference/use_news_md.md),
...
- [`use_author()`](https://usethis.r-lib.org/reference/use_author.md) is
  a new function to introduce a new person into the `Authors@R` field of
  DESCRIPTION ([@avalcarcel9](https://github.com/avalcarcel9),
  [\#833](https://github.com/r-lib/usethis/issues/833)).

- [`use_rstudio_preferences()`](https://usethis.r-lib.org/reference/use_rstudio_preferences.md)
...
- Although nested projects are discouraged, they can be useful in
  ...
  [`create_package()`](https://usethis.r-lib.org/reference/create_package.md)
...
- [`use_data()`](https://usethis.r-lib.org/reference/use_data.md) now
  sets the appropriate minimal R version in `DESCRIPTION`, depending on
  which serialization format `version` you choose
  ([@dpprdan](https://github.com/dpprdan),
  [\#1672](https://github.com/r-lib/usethis/issues/1672)).

- [`use_github_links()`](https://usethis.r-lib.org/reference/use_github_links.md)
...
- [`use_latest_dependencies()`](https://usethis.r-lib.org/reference/use_latest_dependencies.md)
...
- [`use_coverage()`](https://usethis.r-lib.org/reference/use_coverage.md)
...
- [`use_github_release()`](https://usethis.r-lib.org/reference/use_github_release.md)
...
- [`use_version()`](https://usethis.r-lib.org/reference/use_version.md)
  and
  [`use_dev_version()`](https://usethis.r-lib.org/reference/use_version.md)
...
- [`use_revdep()`](https://usethis.r-lib.org/reference/use_revdep.md) no
  longer places an email template, because these days we are more likely
  to communicate with other maintainers about breaking changes via
  GitHub issues and pull requests
  ([\#1769](https://github.com/r-lib/usethis/issues/1769)).

### Package file management

- [`rename_files()`](https://usethis.r-lib.org/reference/rename_files.md)
  now also affects files in `src/`
  ([\#1585](https://github.com/r-lib/usethis/issues/1585)).

- [`use_r()`](https://usethis.r-lib.org/reference/use_r.md) and
  [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) now work
  with all active files in `R/`, `src/`, and `tests/testthat/`
...
- [`use_rcpp()`](https://usethis.r-lib.org/reference/use_rcpp.md),
  [`use_c()`](https://usethis.r-lib.org/reference/use_rcpp.md) and
  friends now work the same way as
  [`use_r()`](https://usethis.r-lib.org/reference/use_r.md) and
  [`use_test()`](https://usethis.r-lib.org/reference/use_r.md): they’ll
  take the default file name from the file you currently have open in
  RStudio ([\#1730](https://github.com/r-lib/usethis/issues/1730)).
...
- [`git_sitrep()`](https://usethis.r-lib.org/reference/git_sitrep.md)
...
- The SVG badges placed by
  [`use_lifecycle()`](https://usethis.r-lib.org/reference/use_lifecycle.md)
...
- [`use_rstudio()`](https://usethis.r-lib.org/reference/use_rstudio.md)
...
- [`write_over()`](https://usethis.r-lib.org/reference/write-this.md)
  and
  [`use_github_file()`](https://usethis.r-lib.org/reference/use_github_file.md)
...
- [`use_tidy_logo()`](https://usethis.r-lib.org/reference/tidyverse.md)
  is a new function that calls
  [`use_logo()`](https://usethis.r-lib.org/reference/use_logo.md) on the
...
- [`use_github_actions_badge()`](https://usethis.r-lib.org/reference/use_github_actions_badge.md)
...
- [`use_data()`](https://usethis.r-lib.org/reference/use_data.md) gains
  an `ascii` argument, which is passed along to
...
- [`use_code_of_conduct()`](https://usethis.r-lib.org/reference/use_code_of_conduct.md)
...
- [`edit_pkgdown_config()`](https://usethis.r-lib.org/reference/edit.md)
...
- [`git_default_branch_rename()`](https://usethis.r-lib.org/reference/git-default-branch.md)
  no longer errors on repos where README exists, but has no badge block.

- [`git_default_branch_rediscover()`](https://usethis.r-lib.org/reference/git-default-branch.md)
...
- [`git_default_branch_configure()`](https://usethis.r-lib.org/reference/git-default-branch.md)
...
- [`use_github_file()`](https://usethis.r-lib.org/reference/use_github_file.md)
  ...
  [`use_template()`](https://usethis.r-lib.org/reference/use_template.md).
...
- [`git_vaccinate()`](https://usethis.r-lib.org/reference/git_vaccinate.md),
  [`edit_git_ignore()`](https://usethis.r-lib.org/reference/edit.md),
  and
  [`git_sitrep()`](https://usethis.r-lib.org/reference/git_sitrep.md)
...
- [`use_github_pages()`](https://usethis.r-lib.org/reference/use_github_pages.md)
  and
  [`use_pkgdown_github_pages()`](https://usethis.r-lib.org/reference/use_pkgdown.md)
...
- [`use_readme_rmd()`](https://usethis.r-lib.org/reference/use_readme_rmd.md)
  and
  [`use_readme_md()`](https://usethis.r-lib.org/reference/use_readme_rmd.md)
...
- [`use_pkgdown()`](https://usethis.r-lib.org/reference/use_pkgdown.md)
...
- [`use_tidy_dependencies()`](https://usethis.r-lib.org/reference/tidyverse.md)
...
- [`edit_rstudio_prefs()`](https://usethis.r-lib.org/reference/edit.md)
  and
  [`edit_rstudio_snippets()`](https://usethis.r-lib.org/reference/edit.md)
...
- Added
  [`edit_template()`](https://usethis.r-lib.org/reference/edit_file.md)
...
- [`use_readme_rmd()`](https://usethis.r-lib.org/reference/use_readme_rmd.md),
  [`use_readme_md()`](https://usethis.r-lib.org/reference/use_readme_rmd.md),
  [`use_tidy_contributing()`](https://usethis.r-lib.org/reference/tidyverse.md),
  and
  [`use_tidy_support()`](https://usethis.r-lib.org/reference/tidyverse.md)
...
- Functions with (deprecated arguments):
  ...
  - [`use_github_links()`](https://usethis.r-lib.org/reference/use_github_links.md)
    (`host`, `auth_token`)
  - [`use_github_labels()`](https://usethis.r-lib.org/reference/use_github_labels.md)
...
[`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md),
[`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md), and
[`create_download_url()`](https://usethis.r-lib.org/reference/use_course_details.md)
...
[`use_git_protocol()`](https://usethis.r-lib.org/reference/git_protocol.md),
and for all R sessions via the `usethis.protocol` option
([\#1262](https://github.com/r-lib/usethis/issues/1262)).

[`pr_resume()`](https://usethis.r-lib.org/reference/pull-requests.md) is
a new function for resuming work on an existing local PR branch. It can
be called argument-less, to select a branch interactively.

[`pr_fetch()`](https://usethis.r-lib.org/reference/pull-requests.md) can
also be called with no arguments, to select a PR interactively. The
`owner` argument is replaced by `target`, with a choice of the source
(default) or primary repo.

[`pr_forget()`](https://usethis.r-lib.org/reference/pull-requests.md) is
a new function for abandoning a PR you initiated locally or fetched from
GitHub. It only does local clean up and, for example, doesn’t delete a
remote branch or close a PR
([\#1263](https://github.com/r-lib/usethis/issues/1263)).

[`pr_view()`](https://usethis.r-lib.org/reference/pull-requests.md) can
now be called with no arguments. If the current branch is associated
with an open PR, we target that and, otherwise, we offer an interactive
selection.

[`pr_finish()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
[`create_from_github()`](https://usethis.r-lib.org/reference/create_from_github.md)
and
[`use_tidy_thanks()`](https://usethis.r-lib.org/reference/use_tidy_thanks.md)
...
[`issue_close_community()`](https://usethis.r-lib.org/reference/issue-this.md)
and
[`issue_reprex_needed()`](https://usethis.r-lib.org/reference/issue-this.md)
...
[`browse_github_actions()`](https://usethis.r-lib.org/reference/browse-this.md)
...
[`use_apl2_license()`](https://usethis.r-lib.org/reference/licenses.md)
(not
[`use_apache_license()`](https://usethis.r-lib.org/reference/licenses.md))
and
[`use_gpl3_license()`](https://usethis.r-lib.org/reference/licenses.md)
no longer modify the license text
([\#1198](https://github.com/r-lib/usethis/issues/1198)).

[`use_mit_license()`](https://usethis.r-lib.org/reference/licenses.md)
...
New
[`use_gpl_license()`](https://usethis.r-lib.org/reference/licenses.md)
and
[`use_agpl_license()`](https://usethis.r-lib.org/reference/licenses.md)
...
New
[`use_proprietary_license()`](https://usethis.r-lib.org/reference/licenses.md)
...
[`use_lgpl_license()`](https://usethis.r-lib.org/reference/licenses.md)
now uses version 3 (and above), and gains new `version` and
`include_future` argument to control which version is used.

[`use_gpl3_license()`](https://usethis.r-lib.org/reference/licenses.md),
[`use_agpl3_license()`](https://usethis.r-lib.org/reference/licenses.md)
and
[`use_apl2_license()`](https://usethis.r-lib.org/reference/licenses.md)
...
[`use_blank_slate()`](https://usethis.r-lib.org/reference/use_blank_slate.md)
...
[`browse_package()`](https://usethis.r-lib.org/reference/browse-this.md)
and
[`browse_project()`](https://usethis.r-lib.org/reference/browse-this.md)
...
[`use_dev_package()`](https://usethis.r-lib.org/reference/use_package.md)
...
[`use_cpp11()`](https://usethis.r-lib.org/reference/use_cpp11.md) is a
new function to set up an R package to use cpp11.
...
[`create_package()`](https://usethis.r-lib.org/reference/create_package.md),
[`create_project()`](https://usethis.r-lib.org/reference/create_package.md),
[`create_from_github()`](https://usethis.r-lib.org/reference/create_from_github.md),
and
[`proj_activate()`](https://usethis.r-lib.org/reference/proj_activate.md)
...
[`use_testthat()`](https://usethis.r-lib.org/reference/use_testthat.md)
...
- [`create_tidy_package()`](https://usethis.r-lib.org/reference/tidyverse.md)
...
- [`pr_pause()`](https://usethis.r-lib.org/reference/pull-requests.md)
  and
  [`pr_fetch()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
- New
  [`ui_silence()`](https://usethis.r-lib.org/reference/ui_silence.md)
...
- New
  [`use_data_table()`](https://usethis.r-lib.org/reference/use_data_table.md)
...
- [`browse_github()`](https://usethis.r-lib.org/reference/browse-this.md)
...
- [`create_download_url()`](https://usethis.r-lib.org/reference/use_course_details.md)
  ...
  with
  [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) and
  [`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md),
...
- [`edit_file()`](https://usethis.r-lib.org/reference/edit_file.md) and
  [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) gain an
  `open` parameter that allows you to control whether or not the
...
- [`ui_yeah()`](https://usethis.r-lib.org/reference/ui-questions.md) and
  [`ui_nope()`](https://usethis.r-lib.org/reference/ui-questions.md)
...
- [`use_circleci()`](https://usethis.r-lib.org/reference/use_gitlab_ci.md)
  uses correct delimiters in template
  ([@jdblischak](https://github.com/jdblischak),
  [\#835](https://github.com/r-lib/usethis/issues/835)).

- [`use_circleci_badge()`](https://usethis.r-lib.org/reference/use_gitlab_ci.md)
...
- [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) and
  [`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md) are
  now equipped with some retry capability, to cope with intermittent
...
- [`use_data_raw()`](https://usethis.r-lib.org/reference/use_data.md)
...
- [`use_description_defaults()`](https://usethis.r-lib.org/reference/use_description.md)
...
- [`use_git()`](https://usethis.r-lib.org/reference/use_git.md) will now
...
- [`use_logo()`](https://usethis.r-lib.org/reference/use_logo.md) now
  generates the correct href if the pkgdown `url` is set
  ([@mitchelloharawild](https://github.com/mitchelloharawild),
  [\#986](https://github.com/r-lib/usethis/issues/986)).

- [`use_make()`](https://usethis.r-lib.org/reference/use_make.md) gains
  missing closing parenthesis ([@ryapric](https://github.com/ryapric),
...
- [`use_testthat()`](https://usethis.r-lib.org/reference/use_testthat.md)
  and [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) now
  work in projects, not just packages
  ([\#1017](https://github.com/r-lib/usethis/issues/1017)).

- [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) works on
  Windows when called without arguments
  ([\#901](https://github.com/r-lib/usethis/issues/901)).

- [`use_tidy_issue_template()`](https://usethis.r-lib.org/reference/tidyverse.md)
...
- [`use_r()`](https://usethis.r-lib.org/reference/use_r.md) and
  [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) throw a
  clear error if multiple names are provided
  ([@strboul](https://github.com/strboul),
  [\#862](https://github.com/r-lib/usethis/issues/862)).

- [`use_rcpp()`](https://usethis.r-lib.org/reference/use_rcpp.md) and
  [`use_c()`](https://usethis.r-lib.org/reference/use_rcpp.md) now
  ensure `src/` contains at least one `.cpp` or `.c` placeholder file,
...
- `usethis.destdir` is a new option that is consulted when deciding
  ...
  [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md) or
  [`create_from_github()`](https://usethis.r-lib.org/reference/create_from_github.md)
  ([@malcolmbarrett](https://github.com/malcolmbarrett),
...
- The templates used by
  [`use_pipe()`](https://usethis.r-lib.org/reference/use_pipe.md) and
  `use_tidy_eval()` use a more robust form of cross-reference links,
...
- [`use_pipe()`](https://usethis.r-lib.org/reference/use_pipe.md) gains
  a logical `export` argument, so it can do the setup necessary to use
  the pipe operator when it is re-exported (`export = TRUE`, which is
  the default and preserves the previous behaviour) and when it is not
  (`export = FALSE`)
...
- [`use_make()`](https://usethis.r-lib.org/reference/use_make.md) and
  [`use_jenkins()`](https://usethis.r-lib.org/reference/use_jenkins.md)
...
- [`use_zip()`](https://usethis.r-lib.org/reference/zip-utils.md) is a
  new variant of
  [`use_course()`](https://usethis.r-lib.org/reference/zip-utils.md)
...
- [`git_remotes()`](https://usethis.r-lib.org/reference/use_git_remote.md)
  and
  [`use_git_remote()`](https://usethis.r-lib.org/reference/use_git_remote.md)
...
- [`git_protocol()`](https://usethis.r-lib.org/reference/git_protocol.md) +
  [`use_git_protocol()`](https://usethis.r-lib.org/reference/git_protocol.md)
...
- [`use_gitlab_ci()`](https://usethis.r-lib.org/reference/use_gitlab_ci.md)
...
- [`use_git_config()`](https://usethis.r-lib.org/reference/use_git_config.md)
...
- [`pr_init()`](https://usethis.r-lib.org/reference/pull-requests.md),
  ...
  [`pr_finish()`](https://usethis.r-lib.org/reference/pull-requests.md),
  and
  [`pr_view()`](https://usethis.r-lib.org/reference/pull-requests.md)
...
- [`use_badge()`](https://usethis.r-lib.org/reference/badges.md) and
...
- [`use_tibble()`](https://usethis.r-lib.org/reference/use_tibble.md)
  and [`use_rcpp()`](https://usethis.r-lib.org/reference/use_rcpp.md)
  ...
  [`use_rcpp()`](https://usethis.r-lib.org/reference/use_rcpp.md) no
...
- [`proj_get()`](https://usethis.r-lib.org/reference/proj_utils.md) and
  [`proj_set()`](https://usethis.r-lib.org/reference/proj_utils.md) no
  longer have a `quiet` argument. The user-facing message about setting
  a project is now under the same control as other messages,
...
- A new set of `ui_*()` functions makes it possible to give your own
  ...
  - block styles:
    [`ui_line()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_done()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_todo()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_oops()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_info()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md).
  - conditions:
    [`ui_stop()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_warn()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md).
  - questions:
    [`ui_yeah()`](https://usethis.r-lib.org/reference/ui-questions.md),
    [`ui_nope()`](https://usethis.r-lib.org/reference/ui-questions.md).
  - inline styles:
    [`ui_field()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_value()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_path()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md),
    [`ui_code()`](https://usethis.r-lib.org/reference/ui-legacy-functions.md).

- [`with_project()`](https://usethis.r-lib.org/reference/proj_utils.md)
  and
  [`local_project()`](https://usethis.r-lib.org/reference/proj_utils.md)
...
- Call [`use_logo()`](https://usethis.r-lib.org/reference/use_logo.md)
  to update the package logo to the latest specifications:
...
- [`use_devtools()`](https://usethis.r-lib.org/reference/rprofile-helper.md)
  ([\#624](https://github.com/r-lib/usethis/issues/624)),
  [`use_conflicted()`](https://usethis.r-lib.org/reference/rprofile-helper.md)
  ([\#362](https://github.com/r-lib/usethis/issues/362)), and
  [`use_reprex()`](https://usethis.r-lib.org/reference/rprofile-helper.md)
  ([\#465](https://github.com/r-lib/usethis/issues/465)) help add useful
  packages to your `.Rprofile`.

- [`use_partial_warnings()`](https://usethis.r-lib.org/reference/rprofile-helper.md)
  helps the user add a standard warning block to `.Rprofile`
  ([\#64](https://github.com/r-lib/usethis/issues/64)).

- [`edit_r_buildignore()`](https://usethis.r-lib.org/reference/edit.md)
...
- [`use_ccby_license()`](https://usethis.r-lib.org/reference/licenses.md)
  adds a CCBY 4.0 license
  ([\#547](https://github.com/r-lib/usethis/issues/547),
  [@njtierney](https://github.com/njtierney)).

- [`use_rcpp_armadillo()`](https://usethis.r-lib.org/reference/use_rcpp.md)
  and
  [`use_rcpp_eigen()`](https://usethis.r-lib.org/reference/use_rcpp.md)
...
- [`use_covr_ignore()`](https://usethis.r-lib.org/reference/use_coverage.md)
...
- [`use_addin()`](https://usethis.r-lib.org/reference/use_addin.md) does
  setup for RStudio addins
  ([\#353](https://github.com/r-lib/usethis/issues/353),
  [@haozhu233](https://github.com/haozhu233)).

- [`use_tutorial()`](https://usethis.r-lib.org/reference/use_tutorial.md)
...
- [`use_citation()`](https://usethis.r-lib.org/reference/use_citation.md)
  creates a basic `CITATION` template and puts it in the right place
  ([\#100](https://github.com/r-lib/usethis/issues/100)).

### Other minor bug fixes and improvements

- [`write_union()`](https://usethis.r-lib.org/reference/write-this.md)
...
- [`use_data()`](https://usethis.r-lib.org/reference/use_data.md) gains
  a `version` argument and defaults to serialization format version 2
  ([\#675](https://github.com/r-lib/usethis/issues/675)).
...
- [`edit_r_profile()`](https://usethis.r-lib.org/reference/edit.md) and
  [`edit_r_environ()`](https://usethis.r-lib.org/reference/edit.md) now
  respect environment variables `R_PROFILE_USER` and `R_ENVIRON_USER`,
  respectively ([\#480](https://github.com/r-lib/usethis/issues/480)).
...
- [`use_logo()`](https://usethis.r-lib.org/reference/use_logo.md) can
  override existing logo if user gives permission
...
- [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) no longer
  forces the filename to be lowercase
  ([\#613](https://github.com/r-lib/usethis/issues/613),
  [@stufield](https://github.com/stufield)).

- [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) will not
  include a `context()` in the generated file if used with testthat
  2.1.0 and above (the future release of testthat)
  ([\#325](https://github.com/r-lib/usethis/issues/325)).

- [`use_tidy_description()`](https://usethis.r-lib.org/reference/tidyverse.md)
...
- [`proj_path()`](https://usethis.r-lib.org/reference/proj_utils.md) is
  newly exported. Use it to build paths within the active project. Like
  [`proj_get()`](https://usethis.r-lib.org/reference/proj_utils.md) and
  [`proj_set()`](https://usethis.r-lib.org/reference/proj_utils.md), it
  is not aimed at end users, but rather for use in extension packages.
  End users should use [rprojroot](https://rprojroot.r-lib.org) or its
  simpler companion, [here](https://here.r-lib.org), to programmatically
  ...
  - [`edit_file()`](https://usethis.r-lib.org/reference/edit_file.md),
    [`write_over()`](https://usethis.r-lib.org/reference/write-this.md),
    and
    [`write_union()`](https://usethis.r-lib.org/reference/write-this.md)
...
- [`proj_sitrep()`](https://usethis.r-lib.org/reference/proj_sitrep.md)
...
- [`use_logo()`](https://usethis.r-lib.org/reference/use_logo.md)
  resizes and adds a logo to a package
  ([\#358](https://github.com/r-lib/usethis/issues/358),
  [@jimhester](https://github.com/jimhester)).

- [`use_spell_check()`](https://usethis.r-lib.org/reference/use_spell_check.md)
...
- [`use_git()`](https://usethis.r-lib.org/reference/use_git.md) only
...
- [`use_github_labels()`](https://usethis.r-lib.org/reference/use_github_labels.md)
  ...
  [`tidy_labels()`](https://usethis.r-lib.org/reference/use_github_labels.md).
...
- [`use_cran_badge()`](https://usethis.r-lib.org/reference/badges.md)
...
- `browse_github_pat()` goes to the webpage where a GitHub user can
  ...
  [`create_from_github()`](https://usethis.r-lib.org/reference/create_from_github.md)
  and
  [`use_github()`](https://usethis.r-lib.org/reference/use_github.md) to
  easily create and connect GitHub repos to local projects.
...
- [`use_tidy_github()`](https://usethis.r-lib.org/reference/tidyverse.md)
...
- [`use_binder_badge()`](https://usethis.r-lib.org/reference/badges.md)
...
- [`browse_github()`](https://usethis.r-lib.org/reference/browse-this.md),
  [`browse_github_issues()`](https://usethis.r-lib.org/reference/browse-this.md),
  [`browse_github_pulls()`](https://usethis.r-lib.org/reference/browse-this.md),
  [`browse_cran()`](https://usethis.r-lib.org/reference/browse-this.md)
...
- [`use_cc0_license()`](https://usethis.r-lib.org/reference/licenses.md)
  applies a CC0 license, particularly appropriate for data packages
  ([\#94](https://github.com/r-lib/usethis/issues/94))

- [`use_lifecycle_badge()`](https://usethis.r-lib.org/reference/badges.md)
...
- `use_r("foo")` creates and edit `R/foo.R` file. If you have a test
  file open, [`use_r()`](https://usethis.r-lib.org/reference/use_r.md)
  will open the corresponding `.R` file
...
- [`use_revdep()`](https://usethis.r-lib.org/reference/use_revdep.md)
...
returned by
[`proj_get()`](https://usethis.r-lib.org/reference/proj_utils.md). This
is cached throughout a session, although it will be updated by
[`create_package()`](https://usethis.r-lib.org/reference/create_package.md)
and
[`create_project()`](https://usethis.r-lib.org/reference/create_package.md).
...
- [`use_pipe()`](https://usethis.r-lib.org/reference/use_pipe.md)
...
- [`use_usethis()`](https://usethis.r-lib.org/reference/rprofile-helper.md)
...
- [`use_package_doc()`](https://usethis.r-lib.org/reference/use_package_doc.md)
  uses more a modern roxygen2 template that requires less duplication.

- [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) will use
  the name of the currently open file in RStudio if you don’t supply an
  explicit name ([\#89](https://github.com/r-lib/usethis/issues/89)).
...
- New [`use_badge()`](https://usethis.r-lib.org/reference/badges.md) for
  adding any badge to a README. Now only prints a todo message if the
  badge does not already exist.

- [`use_directory()`](https://usethis.r-lib.org/reference/use_directory.md)
...
- [`use_build_ignore()`](https://usethis.r-lib.org/reference/use_build_ignore.md)
  now strips trailing `/`

- [`use_git()`](https://usethis.r-lib.org/reference/use_git.md) will
...
- [`use_template()`](https://usethis.r-lib.org/reference/use_template.md)
  and [`use_test()`](https://usethis.r-lib.org/reference/use_r.md) now
  convert title to a slug that only contains lowercase letters, numbers,
  and `-`.
