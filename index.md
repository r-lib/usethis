...
[`proj_get()`](https://usethis.r-lib.org/reference/proj_utils.md) or
[`proj_sitrep()`](https://usethis.r-lib.org/reference/proj_sitrep.md) to
manually query the project and [read more in the
